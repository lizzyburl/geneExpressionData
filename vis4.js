function makeAttributesDictionary(attrData){
...
function makeHistogram(attributes)
{
...
function makePlot( geneX, geneY, studyID, attrData, attributes)
{
				...
				if (keyType.dataType=="string")
					...
					for (colorObjectId in keyType.colorsList)
						...
						if(keyType.numColors<6)
						    ...
						    //colorObject.color = colorInterpolator(j);
						}
